  ...
  return (
    <div className="texto">
      <div>
        ...
        {nameCountrie.name.nativeName ? (
          Object.entries(nameCountrie.name.nativeName).map(([a, b], index) => {
            {
              return index == 0 ? (
                <span key={index}>
                  <h1 key={b.official}>Native Name: </h1> <h2>{b.official}</h2>
                </span>
              ) : (
                ""
              );
        ...
        {nameCountrie.subregion ? (
          <h2>Sub Region: {nameCountrie.subregion}</h2>
        ) : (
          <>
            <h1>sub Region: </h1> <h2>{vacio}</h2>
          </>
        )}

        {nameCountrie.capital ? (
          <h2>Capital: {nameCountrie.capital}</h2>
        ) : (
          <>
            <h1>Capital: </h1> <h2>{vacio}</h2>
          </>
        )}
      </div>
